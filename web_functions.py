...
def load_data():
    ...
    X = df[["AGE","PackHistory","O2_dilution","MWT1","MWT2","MWT1Best","FEV1","FEV1PRED","FVC","FVCPRED","CAT","HAD","SGRQ","AGEquartiles","copd","severity","smoking","Diabetes","muscular","hypertension","AtrialFib"]]
    y = df['Stage']
